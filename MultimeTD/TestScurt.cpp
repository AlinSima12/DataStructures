...
void testAll() { //apelam fiecare functie sa vedem daca exista
	...
	Multime md;
	assert(md.vida() == true);
	assert(md.dim() == 0); //adaug niste elemente
	assert(md.adauga(5) == true);
	assert(md.adauga(1) == true);
	assert(md.adauga(10) == true);
	assert(md.adauga(7) == true);
	assert(md.adauga(-3) == true);
	assert(md.diferentaMaxMin() == 13);
